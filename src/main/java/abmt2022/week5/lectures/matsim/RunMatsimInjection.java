...
import abmt2022.week4.lectures.Link;
import abmt2022.week4.lectures.LinkProvider;
import abmt2022.week4.lectures.NetworkGuice;
	...
	public static void main(String[] args) {
		...
		controler.addOverridingModule(new AbstractModule() {
			...
			public void install() {
				...
				// if we use this solution lines 60 and 66 should be commented out
				//this.addEventHandlerBinding().to(MyEventHandler.class);
